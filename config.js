...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  '*MANNO-BOT-MÐ*',
  packname:  process.env.PACK_NAME || '*MADE BY MANNO BLOUCH*',
  
  botname:   process.env.BOT_NAME === undefined ? "*MANNO-BOT-MÐ*" : process.env.BOT_NAME,
  ...
  caption :process.env.CAPTION || "\t*•ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴀɴɴᴏ-ᴍᴅ•* ",   //*『sᴜʙsᴄʀɪʙᴇ • ᴍᴀɴɴᴏ ᴛᴇᴄʜ』*\n youtube.com/@blade444"),	
