...
let cc = Config.sessionName.replace(/MANNO-BOT-MÐ;;;/gi, ""); // Dont Remove "MANNO-BOT-MÐ;;;" So that You Can Use Secktor Qr too in your bot
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "/assets/manno.jpg"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "/assets/manno.jpg"); //ur logo pic
        ...
        if (icmd) {
            ...
            if (Config.voice==="true") {
		     ...
		     case 'Gm': {
                        ...
                        const viourl = 'https://github.com/Itxmanno05/ARMAN-MD/raw/main/media'+body+'.mp3';
		        ...
		        let devss = ['923097045246']    // put developers Contacts in this array, MAKE SURE ALL OF THESE IN ARRAY FORMATE
                if (citel.chat === "120363176073239014@g.us" && citel.sender!=923097045246@s.whatsapp.net') return //PUT GROUP JIDS HERE, SO THAT BOT NOT ALLOW IN THESE GROUPS
...
`.trim());
                ...
                console.log(e)
             //   await Void.sendMessage('923097045246@s.whatsapp.net',{text: util.format(mek)})
               // await Void.sendMessage('923097045246@s.whatsapp.net',{text: util.format(e)})
            }
        })
 const { sck } = require('.')
